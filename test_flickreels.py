...
curl_url = "https://vidrama.asia/watch/ratu-hamil-sang-bos-mafia--9515/1?provider=flickreelsv2&lang=id&_rsc=1y6gk"
...
headers = {
    ...
    'next-router-state-tree': '%5B%22%22%2C%7B%22children%22%3A%5B%22watch%22%2C%7B%22children%22%3A%5B%5B%22slug%22%2C%22ratu-hamil-sang-bos-mafia--9515%22%2C%22d%22%5D%2C%7B%22children%22%3A%5B%5B%22episode%22%2C%221%22%2C%22d%22%5D%2C%7B%22children%22%3A%5B%22__PAGE__%22%2C%7B%7D%2Cnull%2Cnull%2Cfalse%5D%7D%2Cnull%2Cnull%2Cfalse%5D%7D%2Cnull%2Cnull%2Cfalse%5D%7D%2Cnull%2C%22refetch%22%2Cfalse%5D%7D%2Cnull%2Cnull%2Ctrue%5D',
...
try:
    r = requests.get(curl_url, headers=headers, verify=False)
    print("Status:", r.status_code)
    text = r.text
    # Print the first 1000 characters and look for m3u8 or mp4
    print("Response sample:", text[:1000])
    
    m3u8s = re.findall(r'https?://[^\"]+\.m3u8[^\"]*', text)
    print("M3U8 found:", m3u8s)
