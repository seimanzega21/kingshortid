...
dramas = [
    {"title": "Takdir Sang Abadi", "bookId": "41000115107", "slug": "takdir-sang-abadi"},
    {"title": "Cinta Abadi Seribu Tahun", "bookId": "42000011008", "slug": "cinta-abadi-seribu-tahun"}
]
...
def main():
    print("=" * 60)
    print("STARTING QUEUE SCRAPER 5 - BATCH 2 DRAMAS")
    print("=" * 60)
