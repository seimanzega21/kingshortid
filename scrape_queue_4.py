...
dramas = [
    {"title": "Mahkluk Abadi", "bookId": "41000103735", "slug": "mahkluk-abadi"},
    {"title": "Edukasi Seks Oleh Sahabatku", "bookId": "42000012744", "slug": "edukasi-seks-oleh-sahabatku"},
    {"title": "Si Cantik Melamarku", "bookId": "42000007815", "slug": "si-cantik-melamarku"},
    {"title": "Dokter Sakti Mengguncang Dunia", "bookId": "42000011308", "slug": "dokter-sakti-mengguncang-dunia"},
    {"title": "Tombak Sakti Gadis Desa", "bookId": "42000010833", "slug": "tombak-sakti-gadis-desa"},
    {"title": "Warisan Mata Sakti", "bookId": "41000107043", "slug": "warisan-mata-sakti"},
    {"title": "Sang Pendekar Sakti", "bookId": "41000107021", "slug": "sang-pendekar-sakti"}
]
...
def main():
    print("=" * 60)
    print("STARTING QUEUE SCRAPER 4 - BATCH 7 DRAMAS")
    print("=" * 60)
