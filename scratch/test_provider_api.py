...
candidates = [
    "https://vidrama.asia/api/netshortv2/provider/cubetv?lang=id_ID",
    "https://vidrama.asia/api/netshortv2/provider?name=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/movies?provider=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/feed/1?provider=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/movie?provider=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/list?provider=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/search?provider=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/home?provider=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/provider/movies?name=cubetv&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/provider/cubetv?page=1&size=20&lang=id_ID",
    "https://vidrama.asia/api/netshortv2/movie/provider/cubetv?lang=id_ID"
]
...
for url in candidates:
    try:
        ...
        if r.status_code == 200:
            ...
            # If code is 200 or there's data, print a bit
