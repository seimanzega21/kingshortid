...
LOCAL_SCRIPT = r'd:\kingshortid\ingest_dramaboxa_queue_vps.py'
REMOTE_SCRIPT = '/root/kingshort-admin/ingest_dramaboxa_queue_vps.py'
LOG_FILE = '/var/log/ingest_dramaboxa_kembali_untuk_membalas.log'
...
ssh.exec_command('pkill -f ingest_dramaboxa_queue_vps.py 2>/dev/null || true')
time.sleep(1)
