"""Upload ingest_koki_ceo_vps.py ke VPS dan jalankan"""
import paramiko
import time
...
LOCAL_SCRIPT = r'd:\kingshortid\scratch\ingest_koki_ceo_vps.py'
REMOTE_SCRIPT = '/root/kingshort-admin/ingest_koki_ceo_vps.py'
LOG_FILE = '/var/log/ingest_koki_ceo.log'
...
ssh.exec_command('pkill -f ingest_koki_ceo_vps.py 2>/dev/null || true')
time.sleep(1)
