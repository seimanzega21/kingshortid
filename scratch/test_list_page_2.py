...
url = "https://vidrama.asia/api/dramawave?action=list&page=2"
try:
    ...
    print("Length of dataList on page 2:", len(dataList))
    print("hasMore on page 2:", data.get("data", {}).get("hasMore"))
