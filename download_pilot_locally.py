# -*- coding: utf-8 -*-
"""
LOCAL DOWNLOADER: Download (Dub) Reinkarnasi Pilot Ulung from R2 to D:\Video Drama\Facebook
...
LOCAL_DIR = r"D:\Video Drama\Facebook\(Dub) Reinkarnasi Pilot Ulung"
...
def main():
    print("=" * 65)
    print("STARTING LOCAL DOWNLOADER FOR (Dub) Reinkarnasi Pilot Ulung")
    ...
    while True:
        try:
            ...
            if completed >= TOTAL_EPS:
                print("\nALL 78 EPISODES SUCCESSFULLY DOWNLOADED LOCALLY!")
                break
