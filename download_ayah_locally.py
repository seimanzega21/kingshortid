# -*- coding: utf-8 -*-
"""
LOCAL DOWNLOADER: Download [Dubbing] Apa Ayahku Ternyata Orang Besar from R2 to D:\Video Drama\Facebook
...
LOCAL_DIR = r"D:\Video Drama\Facebook\[Dubbing] Apa Ayahku Ternyata Orang Besar"
...
def main():
    print("=" * 65)
    print("STARTING LOCAL DOWNLOADER FOR [Dubbing] Apa Ayahku Ternyata Orang Besar")
    ...
    while True:
        try:
            ...
            if completed >= TOTAL_EPS:
                print("\nALL 56 EPISODES SUCCESSFULLY DOWNLOADED LOCALLY!")
                break
