...
TEMP_DIR     = 'd:/kingshortid/temp_dotdrama_batch'
...
def main():
    print("=" * 65)
    print("STARTING DOTDRAMA BATCH PIPELINE")
    print("=" * 65)
    r2 = get_r2()
    
    queue_file = 'dotdrama_queue.json'
    ...
    while True:
        ...
        if idx == -1:
            print("All dramas in queue are processed!")
            break
            
        d = queue[idx]
        print(f"\n[{idx+1}/{len(queue)}] Processing next in queue: {d['title']}")
