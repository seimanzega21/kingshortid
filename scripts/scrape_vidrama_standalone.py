...
=============================================
RUN INSTRUCTIONS:
1. Install requirements: pip install requests boto3 botocore
2. Make sure ffmpeg is installed and in PATH
3. Edit the DRAMA_CONFIG below with correct details
4. Run: python scrape_vidrama.py

This script downloads video + subtitle from Vidrama, transcodes to 720p/540p,
uploads to Cloudflare R2, and registers to KingShort API.
"""
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"[DONE] {DRAMA_CONFIG['title']}")
