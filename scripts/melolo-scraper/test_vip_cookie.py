...
cookie_string += f"; sb-gkcnbnlfqdlotnjaizxx-auth-token={encoded_sb}"

# Next-Router-State-Tree from user's cURL
tree = '%5B%22%22%2C%7B%22children%22%3A%5B%22watch%22%2C%7B%22children%22%3A%5B%5B%22slug%22%2C%22dubbingsopir-taksi-mantan-dewa-balap--846959%22%2C%22d%22%5D%2C%7B%22children%22%3A%5B%5B%22episode%22%2C%2211%22%2C%22d%22%5D%2C%7B%22children%22%3A%5B%22__PAGE__%22%2C%7B%7D%5D%7D%5D%7D%5D%7D%5D%7D%5D'
...
headers = {
    ...
    'next-router-state-tree': urllib.parse.unquote(tree)
}

actions = [
    "60e145e892710994ecf74a6d4965d9ebe37563f0cd",
    "702cfd53e692a0da949a93663150f99bdfdd482939",
    "609b377d1a9790600433152e2c9c9413fa1c766972",
    "608cb6ff9c19dd8c5454a1f2782fc7baa0e774a348",
    "7004aeea6da85b36fd56bfd6fdfa4e2b54f11bf604"
]

payloads = [
    '["dubbingsopir-taksi-mantan-dewa-balap--846959",11]',
    '["dubbingsopir-taksi-mantan-dewa-balap--846959","11"]',
    '[{"dramaId":"dubbingsopir-taksi-mantan-dewa-balap--846959","episode":11}]',
    '[{"dramaId":"dubbingsopir-taksi-mantan-dewa-balap--846959","episode":"11"}]'
]
...
for action in actions:
    for p in payloads:
        ...
        print(f"Action {action} with Payload {p} -> {r.status_code}")
        text = r.text
        if len(text) > 200:
        ...
        if 'proxy?url=' in text or 'akamai' in text:
            print("  *** FOUND PROXY URL! ***")
            break
