...
# -*- coding: utf-8 -*-
"""
KingShort Vidrama Scraper for DramaWaveV2 Provider
==================================================
Downloads dramas from dramawavev2 provider on vidrama.asia,
...
TEMP_DIR = Path(tempfile.gettempdir()) / 'dramawavev2_scraper'
...
def scrape_single_drama(r2, movie_id, is_test_run=False):
    ...
    url = f"https://vidrama.asia/api/dramawavev2?action=detail&id={movie_id}"
    ...
    try:
        ...
        for ep in eps:
            ...
            stream_url = f"https://vidrama.asia/api/dramawavev2?action=stream&id={movie_id}&episode={ep_no}"
            vurl = None
            subtitles = []
