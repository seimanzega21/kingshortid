...
# -*- coding: utf-8 -*-
"""
Scraper for 4 dramas from Vidrama:
#2 Sang Pewaris Jawara Pedang Pertama
#3 Romantis di Musim Dingin
#5 Saat Aku Murka, Dunia Berguncang
"""
import sys
...
DRAMAS_TO_SCRAPE = [
    {'title': 'Sang Pewaris Jawara Pedang Pertama', 'vidrama_id': '1945052237676912642', 'slug': 'sang-pewaris-jawara-pedang-pertama'},
    {'title': 'Romantis di Musim Dingin', 'vidrama_id': '1894650560457961473', 'slug': 'romantis-di-musim-dingin'},
    {'title': 'Saat Aku Murka, Dunia Berguncang', 'vidrama_id': '2029735379636060162', 'slug': 'saat-aku-murka-dunia-berguncang'},
]
...
def process_drama(cfg, r2):
    slug, vidrama_id = cfg['slug'], cfg['vidrama_id']
    prefix = f"netshortv2/{slug}"
    print(f"\n{'='*65}")
    print(f"[DRAMA] {cfg['title']} ({vidrama_id})")
    ...
    print(f"\n[DONE] {cfg['title']}: Total={total_eps}, New={success}, Skipped={skipped}, Failed={failed}, DB={db_id}")

def main():
    r2 = get_r2()
    for cfg in DRAMAS_TO_SCRAPE:
